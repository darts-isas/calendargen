...
<!--                </label>-->
        ...
        <div class="container">
            <section class="example-img">
                <div class="container">
                    <div class="example">
                        ...
                        <a href="img/ex/example07.jpg" data-lightbox="example"
                           data-title="16:9/一年/大/右下/月曜始まり/土曜-なし/日曜-なし/祝日-なし/横組み の使用例">
                            <img src="img/ex/example07.jpg" alt="例１">
                        </a>

                        <a href="img/ex/example02.jpg" data-lightbox="example"
                           data-title="16:10/4・5・6月/中/中央/月曜始まり/土曜-青/日曜-赤/祝日-なし/縦組み の使用例">
                            <img src="img/ex/example02.jpg" alt="例２">
                        </a>

                        <a href="img/ex/example08.jpg" data-lightbox="example"
                           data-title="16:9/1~6月/特大/右下/日曜始まり/土曜-なし/日曜-赤/祝日-赤/縦組み の使用例">
                            <img src="img/ex/example08.jpg" alt="例３">
                        </a>

                        <a href="img/ex/example09.jpg" data-lightbox="example"
                           data-title="16:10/1・2・3月/大/中央/月曜始まり/土曜-なし/日曜-なし/祝日-なし/横組み の使用例">
                            <img src="img/ex/example09.jpg" alt="例４">
                        </a>

                        <a href="img/ex/example06.jpg" data-lightbox="example"
                           data-title="16:10/3・4月/中/右下/日曜始まり/土曜-青/日曜-赤/祝日-赤/縦組み の使用例">
                            <img src="img/ex/example06.jpg" alt="例５">
                        </a>

                        <a href="img/ex/example10.jpg" data-lightbox="example"
                           data-title="16:9/11・12月/極小/左上/日曜始まり/土曜-青/日曜-赤/祝日-赤/横組み の使用例">
                            <img src="img/ex/example10.jpg" alt="例６">
                        </a>
                    </div>
                </div>
            </section>
            ...
            <p>プレビューボタンで選択を反映<br>クリックで拡大表示</p>
                <a href="<?php echo $file_name; ?>" data-lightbox="preview"
                   data-title="プレビュー">
